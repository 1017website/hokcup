  ...
  <main id="home">
    ...
    <section class="section news-section" id="news">
      <div class="container">
        ...
        <div class="news-grid">
          @forelse(($newsArticles ?? collect()) as $article)
          ...
          @empty
            <div class="frontend-empty-state">
              ...
              <span>Tambahkan artikel dari CMS agar tampil di bagian ini.</span>
            </div>
          @endforelse
        </div>
      </div>
    ...
    <section class="section career-section" id="karir">
      <div class="container">
        ...
        <div class="career-grid">
          @forelse(($careerPositions ?? collect()) as $career)
          ...
          @empty
            <div class="frontend-empty-state">
              ...
              <span>Tambahkan lowongan dari CMS agar tampil di bagian ini.</span>
            </div>
          @endforelse
        </div>
      </div>
