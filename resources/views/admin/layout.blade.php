@php
  $adminHeadSetting = \App\Models\SiteSetting::query()->first();
  $adminHeadFavicon = $adminHeadSetting?->favicon_url ?: ($adminHeadSetting?->logo_url ?? null);
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
  ...
  @if($adminHeadFavicon)
    <link rel="icon" href="{{ $adminHeadFavicon }}">
    <link rel="shortcut icon" href="{{ $adminHeadFavicon }}">
    <link rel="apple-touch-icon" href="{{ $adminHeadFavicon }}">
  @endif
